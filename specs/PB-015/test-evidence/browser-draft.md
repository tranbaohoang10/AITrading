...
- main "Trading Workspace":
  ...
  - tablist "Workspace views":
    - tab "Chart"
    - tab "Strategy DSL"
    - tab "Pine Script" [active] [selected]
    - tab "MQL5"
    - tab "Backtest Results"
    - tab "Trades"
  - tabpanel "Pine Script":
    - generic: Revision 1 is DRAFT. Validate and save it in Strategy DSL before exporting. No demo code is substituted.