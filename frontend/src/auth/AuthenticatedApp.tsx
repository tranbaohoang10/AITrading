...
export function AuthenticatedApp() {
  ...
  return <AuthContext.Provider value={{ user, update: setUser, clear: () => { setUser(null); setStatus('anonymous') } }}>
    <ConversationProvider key={user.id}><MarketProvider><StrategyProvider><BacktestProvider><App /></BacktestProvider></StrategyProvider></MarketProvider></ConversationProvider>
