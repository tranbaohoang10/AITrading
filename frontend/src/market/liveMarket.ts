...
export const DEFAULT_INSTRUMENTS: Instrument[] = [
  ...
  { symbol: 'EUR-USD', displaySymbol: 'EUR/USD', name: 'Euro / U.S. Dollar', assetClass: 'FOREX', base: 'EUR', quote: 'USD', exchange: 'ECB', provider: 'FRANKFURTER', feed: 'ECB · EOD', priceIncrement: 0.00001, pricePrecision: 5, modes: ['HISTORICAL', 'DELAYED'] },
  { symbol: 'GBP-USD', displaySymbol: 'GBP/USD', name: 'British Pound / U.S. Dollar', assetClass: 'FOREX', base: 'GBP', quote: 'USD', exchange: 'ECB', provider: 'FRANKFURTER', feed: 'ECB · EOD', priceIncrement: 0.00001, pricePrecision: 5, modes: ['HISTORICAL', 'DELAYED'] },
  ...
  { symbol: 'USD-CHF', displaySymbol: 'USD/CHF', name: 'U.S. Dollar / Swiss Franc', assetClass: 'FOREX', base: 'USD', quote: 'CHF', exchange: 'ECB', provider: 'FRANKFURTER', feed: 'ECB · EOD', priceIncrement: 0.00001, pricePrecision: 5, modes: ['HISTORICAL', 'DELAYED'] },
  { symbol: 'AUD-USD', displaySymbol: 'AUD/USD', name: 'Australian Dollar / U.S. Dollar', assetClass: 'FOREX', base: 'AUD', quote: 'USD', exchange: 'ECB', provider: 'FRANKFURTER', feed: 'ECB · EOD', priceIncrement: 0.00001, pricePrecision: 5, modes: ['HISTORICAL', 'DELAYED'] },
  { symbol: 'USD-CAD', displaySymbol: 'USD/CAD', name: 'U.S. Dollar / Canadian Dollar', assetClass: 'FOREX', base: 'USD', quote: 'CAD', exchange: 'ECB', provider: 'FRANKFURTER', feed: 'ECB · EOD', priceIncrement: 0.00001, pricePrecision: 5, modes: ['HISTORICAL', 'DELAYED'] },
  { symbol: 'NZD-USD', displaySymbol: 'NZD/USD', name: 'New Zealand Dollar / U.S. Dollar', assetClass: 'FOREX', base: 'NZD', quote: 'USD', exchange: 'ECB', provider: 'FRANKFURTER', feed: 'ECB · EOD', priceIncrement: 0.00001, pricePrecision: 5, modes: ['HISTORICAL', 'DELAYED'] },
