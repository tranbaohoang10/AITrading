...
export const source: Revision = {
  strategyId: '11111111-1111-4111-8111-111111111111', revision: 2, title: 'Synthetic Pine research', draftText: '{}',
...
export const artifact: Artifact = {
  ...
  generatorVersion: 'pine-research-1.0.0', codeHash: 'b'.repeat(64), code: '//@version=6\n// <script>alert(1)</script> inert fixture\nindicator("Synthetic")\nplot(close)\n',
