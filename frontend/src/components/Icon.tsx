...
const paths: Record<string, string> = {
  ...
  aiCapture: 'M7 4H4v3m13-3h3v3M7 20H4v-3m13 3h3v-3M8 12a4 4 0 1 0 8 0 4 4 0 0 0-8 0Z',
  ...
  crosshair: 'M12 3v4m0 10v4M3 12h4m10 0h4M12 9a3 3 0 1 0 0 6 3 3 0 0 0 0-6Z',
  trend: 'M4 18 10 8l4 5 6-9M4 18h4',
  longPosition: 'M4 19h16M7 16h10M12 16V6m0 0-3 3m3-3 3 3M7 19v-3h10v3',
  shortPosition: 'M4 5h16M7 8h10M12 8v10m0 0-3-3m3 3 3-3M7 5v3h10V5',
  stay: 'M6 8h9l-2-2m2 2-2 2M18 16H9l2-2m-2 2 2 2M5 5v14h14',
  ...
  parallelChannel: 'M4 17 15 6m-8 12L18 7M4 17h5M15 6h5',
  polyline: 'M4 18 9 8l5 7 6-10',
  triangle: 'M12 5 20 19H4L12 5Z',
  priceNote: 'M4 7h16M4 12h10M4 17h16',
  repeat: 'M6 8h9l-2-2m2 2-2 2M18 16H9l2-2m-2 2 2 2M5 5v14h14',
  eraser: 'm5 16 8-8 6 6-8 8H5v-6Zm8-8 2-2 4 4-2 2',
