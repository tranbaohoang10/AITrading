...
function DemoChart() {
  return (
    <section aria-label="Chart" data-testid="chart-view" className="flex h-full min-h-0 flex-col">
      <div data-testid="chart-toolbar" className="flex flex-wrap items-center gap-2 border-b border-slate-800 bg-slate-900 px-3 py-2">
        <label className="flex min-h-9 items-center gap-2 rounded-md border border-slate-700 bg-slate-950 px-3 text-[11px] font-semibold text-slate-500">
          Symbol
        ...
        <button type="button" disabled title="Fixed illustrative overlays only" className="min-h-9 rounded-md border border-slate-700 bg-slate-950 px-3 text-xs text-slate-300 focus-visible:ring-2 focus-visible:ring-emerald-400">Indicator <span className="ml-1 text-emerald-300">EMA · RSI</span></button>
        <button type="button" disabled title="Chart settings available with the connected chart workspace" className="min-h-9 rounded-md border border-slate-700 bg-slate-950 px-3 text-xs text-slate-300 focus-visible:ring-2 focus-visible:ring-emerald-400">Settings</button>
      </div>
      ...
      <div className="flex min-h-0 flex-1 flex-col p-3 sm:p-4">
        ...
        <div data-testid="mock-chart" className="terminal-gridline relative min-h-[220px] flex-1 overflow-hidden rounded-md border border-slate-800 bg-slate-950" aria-label="Native mock candlestick chart">
