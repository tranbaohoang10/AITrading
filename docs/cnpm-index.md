...
| 9 | ERD | [Aggregate ERD](architecture.md#aggregate-erd-and-migration-ledger), exact [V1–V22 SHA ledger](readiness-migrations.json), feature migration diagrams |
...
V21 bổ sung kho nến provider M1 và trạng thái coverage/sync; hash V1–V20 được giữ
nguyên và ma trận kiểm thử thật nằm trong `specs/PB-049/evidence.md`.
