...
| PB-025 | System integration and failure recovery | PB-004, PB-009, PB-012, PB-014, PB-017, PB-018, PB-019, PB-022, PB-023, PB-024 | P1 | READY | not created | End-to-end account→chat→DSL→backtest→journal→export/RAG; restarts/errors recover without mixing users | Trust boundaries and data-loss safeguards across real services | Browser+API+DB+Python journeys, provider unavailable, migrations, concurrency |
