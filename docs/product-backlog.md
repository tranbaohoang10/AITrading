...
| PB-010 | Deterministic Python backtest engine | PB-005, PB-006 | P0 | IN_PROGRESS | [#11](https://github.com/tranbaohoang10/AITrading/issues/11) | Reproducible bar events, next-bar execution, indicator warm-up, costs/sizing/leverage/SL/TP ambiguity, hashes/run card | Bounds/timeouts, no look-ahead/eval, fail unsupported multi-symbol/timeframe combos explicitly | Hand-computed trades, prefix invariance, missing/duplicate candles, same-candle exits, long/short and costs |
