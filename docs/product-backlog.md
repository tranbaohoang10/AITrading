...
| PB-003 | Authentication and user management | PB-001, PB-002 | P0 | IN_PROGRESS | [#6](https://github.com/tranbaohoang10/AITrading/issues/6) | Register/login/logout/current user; Argon2id; backend sessions/ownership principal; account settings and password change | CSRF, fixation/revocation, brute force/enumeration, hash secrecy, concurrent uniqueness | Auth API and browser journeys, two users, expiry/forgery/rate-limit/concurrency |
