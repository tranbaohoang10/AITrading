...
| PB-009 | Natural-language strategy generation | PB-007, PB-008 | P1 | DONE | [#21](https://github.com/tranbaohoang10/AITrading/issues/21) | Delivered9c1a211; CI33462951447 SUCCESS; Issue completed; prompt → structured DSL draft → explicit validation and acceptance | AI output never executable code; ownership, injection and resource controls | 235 backend/213 frontend/44 Python; real Gemini synthetic proposal/clarification, replay/restart/isolation |
...
| PB-015 | Pine Script export from DSL | PB-007, PB-010 | P1 | DONE | [#17](https://github.com/tranbaohoang10/AITrading/issues/17) | Deliveredbb015be; CI33518039202 SUCCESS; 8/8 official Pine traces and current288backend/226frontend/44Python regression PASS | No arbitrary templates/code injection; owner export | Eight complete official synthetic traces match pinned Python event/accounting expectations |
| PB-016 | MQL5 export from DSL | PB-007, PB-010 | P1 | DONE | [#18](https://github.com/tranbaohoang10/AITrading/issues/18) | Delivered93f96c8; CI33488433090 SUCCESS; compile8/8 and official isolated portable runtime evidence PASS | No orders/network/DLL; sandbox/device-name/finite-state guards; owner artifact/account binding | Eight event/accounting traces verified; actual CSV negatives including future-data rejection PASS |
| PB-017 | Cross-target event consistency | PB-010, PB-015, PB-016 | P1 | DONE | [#26](https://github.com/tranbaohoang10/AITrading/issues/26) | Delivered 8df08f4; CI33583487174 SUCCESS; Issue completed; 8/8 fixtures, 51 bars and zero unexplained divergence | Fail-closed provenance/hash/path/completeness and malformed/tampered/nonfinite/oversize evidence | 1,359 Pine assertions, 764 retained Pine raw fields, 1,410 MQL5 actual fields; 50 Python + CI regression PASS |
...
| PB-019 | Chart/image analysis | PB-006, PB-008, PB-018 | P2 | DONE | [#25](https://github.com/tranbaohoang10/AITrading/issues/25) | Delivered43d0e21; CI33474327220 SUCCESS; provider-neutral bounded image analysis separates visible evidence/inference/confidence/missing data and survives restart | Canonical PNG, owner/account/session/CSRF, metadata removal, no URLs/tools/code, secret isolation | 288 backend/226 frontend/44 Python/6 verifier; real Gemini synthetic image, replay/restart/isolation; npm0/OSV121-0 |
...
| PB-024 | Audit and operational diagnostics | PB-002, PB-003 | P1 | DONE | [#19](https://github.com/tranbaohoang10/AITrading/issues/19) | Delivered401f969; CI33393395877 SUCCESS; Issue completed; auth/resource/job request-ID trace, retention/redaction and health | No tokens/passwords/private prompts in logs; append-only events and ownership | 174 backend/193 frontend/44 Python; browser/restart/two-user and dependency audits PASS |
| PB-025 | System integration and failure recovery | PB-004, PB-009, PB-012, PB-014, PB-017, PB-018, PB-019, PB-022, PB-023, PB-024 | P1 | DONE | [#27](https://github.com/tranbaohoang10/AITrading/issues/27) | Delivered 6b82af8; CI33585991238 SUCCESS; Issue completed; actual API/PG/Python/browser journey and restart recovery | Two-user/account/CSRF/provider-unavailable boundaries; no fake AI or external target | 288 backend/226 frontend/52 Python; npm0/OSV121-0; exact snapshots and cleanup PASS |
| PB-026 | Prototype readiness and thesis artifact assembly | PB-025 | P1 | DONE | [#28](https://github.com/tranbaohoang10/AITrading/issues/28) | Delivered b579946; CI33603606339 SUCCESS; Issue completed; honest matrix/setup and all nine CNPM groups | Secret/stale-claim/migration/path checks; explicit prototype exclusions | 288 backend/226 frontend/58 Python; source-only verification; 17 migrations/26 tables/61 images/0 gaps |
