...
| PB-005 | Versioned neutral Strategy DSL | PB-002 | P0 | IN_PROGRESS | [#8](https://github.com/tranbaohoang10/AITrading/issues/8) | Typed bounded measurable conditions/risk/execution; schema+semantic validation; explicit unsupported cases; immutable versions | No eval/scripts; bounded trees/periods/symbols, canonical hashing | Known valid/invalid families, malformed/deep DSL, deterministic hashes |
