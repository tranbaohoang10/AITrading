...
| PB-012 | Backtest results and chart visualization | PB-001, PB-006, PB-011 | P1 | IN_PROGRESS | [#14](https://github.com/tranbaohoang10/AITrading/issues/14) | Real equity/drawdown/metrics/trades; date/strategy provenance; overlay signals; no demo metrics presented as calculated | Safe rendering/export, owner-scoped retrieval | Reconcile metrics with trades, zero-trade/loss-only cases, browser desktop/mobile |
