...
| PB-016 | MQL5 export from DSL | PB-007, PB-010 | P1 | IN_PROGRESS | [#18](https://github.com/tranbaohoang10/AITrading/issues/18) | Research CSV export, compile8/8 and official isolated portable runtime evidence PASS; publication/CI/Issue completion pending | No orders/network/DLL; sandbox/device-name/finite-state guards; owner artifact/account binding | Eight event/accounting traces verified; actual CSV negatives including future-data rejection PASS |
