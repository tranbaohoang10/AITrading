...
| PB-014 | AI/NLP journal evaluation | PB-008, PB-013 | P1 | IN_PROGRESS | [#22](https://github.com/tranbaohoang10/AITrading/issues/22) | Evidence-grounded reason-quality rubric/score and natural-language feedback; documented model choice incl BERT trade-off; disclaimer | Journal remains private, prompt injection, score bounds, no guaranteed advice | Rubric fixtures, missing reasons, multilingual/provider failure, privacy |
