...
| PB-017 | Cross-target event consistency | PB-010, PB-015, PB-016 | P1 | IN_PROGRESS | [#26](https://github.com/tranbaohoang10/AITrading/issues/26) | Local verifier PASS 8/8: 51 bars, 1,359 Pine assertions, 764 retained Pine raw fields and 1,410 MQL5 actual fields; publication/CI pending | Fail-closed provenance/hash/path/completeness and malformed/tampered/nonfinite/oversize evidence; zero unexplained divergence | 6 PB-017 tests plus 50 Python, 6 verifier, canonical/UI fixtures PASS; no target rerun |
