...
| PB-015 | Pine Script export from DSL | PB-007, PB-010 | P1 | IN_PROGRESS | [#17](https://github.com/tranbaohoang10/AITrading/issues/17) | Experimental research export implemented; 8/8 official Pine traces and current288backend/226frontend/44Python regression PASS; publication SHA/CI pending | No arbitrary templates/code injection; owner export | Eight complete official synthetic traces match pinned Python event/accounting expectations |
