...
| PB-027 | Expected-account binding across private workspace APIs | PB-003, PB-004, PB-006, PB-007, PB-011, PB-012, PB-013 | P0 | IN_PROGRESS | [#16](https://github.com/tranbaohoang10/AITrading/issues/16) | Focused security fix discovered in PB-013 review: captured workspace identity enforced before private reads/writes, safe shared-session changes and logout; no redo of DONE business features | Prevent stale-tab content transfer and wrong-account side effects, preserve CSRF/ownership/revocation | Missing/wrong/matching identity, delayed requests/retries, real two-tab browser and full regression |
